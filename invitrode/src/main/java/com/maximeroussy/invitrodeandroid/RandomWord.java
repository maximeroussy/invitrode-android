package com.maximeroussy.invitrodeandroid;
...
public class RandomWord {
    ...
    private static String[] START_BIGRAM = {"TH","OF","AN","IN","TO","CO","BE","HE","RE","HA","WA","FO","WH","MA","WI", "ON","HI","PR","ST","NO","IS","IT","SE","WE","AS","CA","DE","SO","MO","SH","DI","AL","AR","LI","WO","FR","PA","ME","AT","SU","BU","SA","FI","NE","CH","PO","HO","DO","OR","UN","LO","EX","BY","FA","LA","LE","PE","MI","SI","YO","TR","BA","GO","BO","GR","TE","EN","OU","RA","AC","FE","PL","CL","SP","BR","EV","TA","DA","AB","TI","RO","MU","EA","NA","SC","AD","GE","YE","AF","AG","UP","AP","DR","US","PU","CE","IF","RI","VI","IM","AM","KN","OP","CR","OT","JU","QU","TW","GA","VA","VE","PI","GI","BI","FL","BL","EL","JO","FU","HU","CU","RU","OV","MY","OB","KE","EF","PH","CI","KI","NI","SL","EM","SM","VO","MR","WR","ES","DU","TU","AU","NU","GU","OW","SY","JA","OC","EC","ED","ID","JE","AI","EI","SK","OL","GL","EQ","LU","AV","SW","AW","EY","TY"};
    ...
    public static String getNewWord(int wordLength) {
        String theNewWord = "e";
    ...
    private static String generateRandomWord(int wordLength) {
        String randomWord;
        randomWord = START_BIGRAM[indexGenerator(START_BIGRAM.length)];
        int flag = 0;
        int count = 0;
        String previousWord;
        ...
        while (randomWord.length() != wordLength) {
            ...
            randomWord = addCharacter(START_BIGRAM, wordLength, randomWord, LOOKUP_BIGRAM, NEXT_CHAR_LOOKUP, flag);
    ...
    private static String addCharacter(String[] startBiGram, int desiredLength, String currentWord, String[] lookupBiGram, String[][][] nextCharLookup, int flag){
    ...
    private static int indexGenerator(int arrayLength) {
        ...
        return generator.nextInt(arrayLength);
    }

    private static String getNextCharacter(int type, int mainIndex, String[][][] theCharacterVault) {
        int i = indexGenerator(theCharacterVault[mainIndex][type].length);

        return theCharacterVault[mainIndex][type][i];
    }
